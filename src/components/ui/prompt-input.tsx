  ...
  return (
    <TooltipProvider>
      ...
      >
        <div
          className={cn(
            "border-input bg-background rounded-md border p-2",
            className,
          )}
        >
          {children}
...
function PromptInputTextarea({
  ...
  return (
    <Textarea
      ...
      onBlur={props.onBlur}
      className={cn(
        "min-h-[44px] w-full resize-none border-none bg-transparent text-inherit shadow-none outline-none focus-visible:ring-0 focus-visible:ring-offset-0 text-base sm:text-sm",
        className,
      )}
      rows={1}
      disabled={disabled}
